      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          ...
          colorScheme: ColorScheme(
            onPrimary: const Color.fromARGB(255, 241, 234, 228),
            onSecondary: const Color.fromARGB(255, 241, 234, 228),
            error: Colors.red,
            onError: Color.fromARGB(255, 124, 8, 0),
            onBackground: Colors.black,
            onSurface: Colors.black,
            primary: const Color.fromARGB(255, 241, 234, 228),
            surface: Colors.black,
            background: const Color.fromARGB(255, 241, 234, 228),
            brightness: Brightness.dark,
            secondary: const Color.fromARGB(255, 241, 234, 228),
          ),
